---
{"dg-publish":true,"permalink":"/05-wiki/mark-down/","tags":["#Markdown #Obsidian","gardenEntry"]}
---
...
如果你有一定的MD语法基础，可以直接[[05-WIKI百科/MarkDown超级教程#19 避免标识符的滥用\|点击跳转]]
## Markdown 相关软件推荐
...
|                  表头1                  |                        表头2                        |
|:---------------------------------------:|:---------------------------------------------------:|
| [[05-WIKI百科/MarkDown超级教程#例2 表格内 单元格中的竖杠\|单元格中的竖杠]] | [[05-WIKI百科/MarkDown超级教程#例3 不会变成代码的反引号\|不会变成代码的反引号]] |
```
...
使用 转义符号`\` 让 反引号`` ` `` 变成普通字符，不再具有[[05-WIKI百科/MarkDown超级教程#7 1 行内代码\|行内代码]]的标识符功能
